...
NAN_MODULE_INIT(Io::Init) {
  ...
  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_EXR_TYPE, Nan::New<v8::Integer>(cv::IMWRITE_EXR_TYPE)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_HDR_COMPRESSION, Nan::New<v8::Integer>(cv::IMWRITE_HDR_COMPRESSION)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_TIFF_RESUNIT, Nan::New<v8::Integer>(cv::IMWRITE_TIFF_RESUNIT)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_TIFF_XDPI, Nan::New<v8::Integer>(cv::IMWRITE_TIFF_XDPI)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_TIFF_YDPI, Nan::New<v8::Integer>(cv::IMWRITE_TIFF_YDPI)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_TIFF_COMPRESSION, Nan::New<v8::Integer>(cv::IMWRITE_TIFF_COMPRESSION)); // added 2024-13-09

  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR_411, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR_411)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR_420, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR_420)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR_422, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR_422)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR_440, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR_440)); // added 2024-13-09
  FF_SET_JS_PROP(target, IMWRITE_JPEG_SAMPLING_FACTOR_444, Nan::New<v8::Integer>(cv::IMWRITE_JPEG_SAMPLING_FACTOR_444)); // added 2024-13-09
